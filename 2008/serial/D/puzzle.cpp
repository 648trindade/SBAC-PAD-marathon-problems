...
Puzzle::Puzzle(int size) { allocate(size); }
...
bool Puzzle::move_up()
{
    ...
    {
        // Possible move
        puzzle[hole_pos_x][hole_pos_y] = puzzle[hole_pos_x - 1][hole_pos_y];
...
bool Puzzle::move_left()
{
    ...
    {
        // Possible move
        puzzle[hole_pos_x][hole_pos_y] = puzzle[hole_pos_x][hole_pos_y - 1];
...
int Puzzle::total_cost() const { return (moves_made + cost); }
