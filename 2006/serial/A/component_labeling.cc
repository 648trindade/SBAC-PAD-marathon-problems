...
void fill(long unsigned int** output, const long unsigned int h,
          const long unsigned int n, const long unsigned int** input,
          const long unsigned int i, const long unsigned int j,
...
void component_labeling(int argc, char* argv[], long unsigned int** output,
                        const long unsigned int n,
                        const long unsigned int** input)
{
